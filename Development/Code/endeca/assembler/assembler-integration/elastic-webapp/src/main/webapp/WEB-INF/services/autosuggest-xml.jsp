...
<% 
	pageContext.setAttribute("contentItem", new ContentSlotConfig("/content/Browse/SearchBoxAutoSuggestContent", 1));
	request.setAttribute("Endeca.Infront.Service", "autosuggest");
%>
<discover:serve contentItem="${contentItem}" format="eaxml" />
